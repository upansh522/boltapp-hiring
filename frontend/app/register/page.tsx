...
const messageFrom = (error: unknown) => {
  ...
  if (data && typeof data === "object") {
    const details = (
      data as { errors?: Record<string, string[]>; message?: string }
    ).errors;
    return details
  ...
  return (
    <main className="site-shell inner-page">
      ...
      <section className="register-wrap">
        <span className="design-label">Create your account</span>
        <div className="register-card">
          {complete ? (
            <div className="register-success">
              ...
              <strong>{code}</strong>
              <small>Keep this code for future login.</small>
            ...
            <>
              <form className="registration-form" onSubmit={submit}>
                ...
                <p>Register to receive your 6-digit login code</p>
                {error && (
              ...
              <aside className="register-art" aria-hidden="true">
                ...
                <div className="art-copy">
                  ...
                  <span>
                    ...
                    <br />
                    <small>We never share your data.</small>
                  </span>
                </div>
              </aside>
            </>
